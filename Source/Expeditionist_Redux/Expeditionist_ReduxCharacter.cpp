...
void AExpeditionist_ReduxCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AExpeditionist_ReduxCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AExpeditionist_ReduxCharacter::Move);
